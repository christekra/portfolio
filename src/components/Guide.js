...
const Guide = () => {
  ...
  const SKILL_MESSAGES = useMemo(() => ({
    ...
    'react native': "📱 React Native : applications mobiles performantes et code partagé.",
    ...
    'html / css': "🧱 HTML5 & CSS3 : interfaces soignées, responsive et accessibles.",
    inertia: "🌀 Inertia.js : pont fluide entre Laravel et React pour des expériences hybrides.",
    git: "🔁 Git : branching stratégique, hooks et workflows collaboratifs.",
    github: "🌐 GitHub : projets open-source, issues bien gérées et collaboration efficace.",
    ...
    seo: "🔍 SEO : structure optimisée, performance web et visibilité sur Google.",
